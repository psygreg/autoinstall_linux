...
echo "Esta versão também instala drivers para placas de vídeo Nvidia. Se a sua placa não for desta fabricante, ou não quiser atualizar seus drivers de vídeo, use o *AutoInstall AMD* em vez deste."
